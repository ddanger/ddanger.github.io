...
- [ ] Run `npm run update:resume` to regenerate `images/social/resume-share.png`, bump the cache-busting version, and rebuild the site HTML
- [ ] Visually verify the output image looks correct
- [ ] `git add Resume-David-Dangerfield.pdf images/social/resume-share.png src/site.json index.html about/index.html contact/index.html services/index.html`
- [ ] Commit and push

The social-share image and versioned resume URL must be committed alongside the PDF — they are not auto-generated by CI.
