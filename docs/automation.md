...
- [ ] Run `npm run generate:resume-share` to regenerate `images/social/resume-share.png`
- [ ] Visually verify the output image looks correct
- [ ] `git add Resume-David-Dangerfield.pdf images/social/resume-share.png`
- [ ] Commit and push

The social-share image must be committed alongside the PDF — it is not auto-generated by CI.
